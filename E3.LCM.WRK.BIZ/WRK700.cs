...
namespace E3.LCM.WRK.BIZ
{
    public class WRK700
    {
        ...
        public DataPackage selectMainList(DataPackage package)
        {
            ...
            try
            {
                DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("WRK700_SELECT", package.KeyValues);
        ...
        public DataPackage saveMainList(DataPackage package)
        {
            ...
            try
            {
                ...
                DataTable checkDt = DataMapper.DefaultMapper.QueryForDataTable("WRK700_CHECK_EMPTY", param);
                ...
                checkDt = DataMapper.DefaultMapper.QueryForDataTable("WRK700_CHECK_USE", param);
                ...
                {
                    DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("WRK700_CHECK_CNT", param);
                  ...
                  /*  else if (rowState.Equals("I"))
                    {
                            checkDt = DataMapper.DefaultMapper.QueryForDataTable("WRK700_CHECK_NM", param);

                            if (checkDt != null && checkDt.Rows[0]["CNT"].ToInt() > 0)
                            {
                                returnPackage.ErrorMessage = "중복되는 설비종류명이 존재합니다.";
                                returnPackage.KeyValues.Add("Method", "INSERT");
                                returnPackage.KeyValues.Add("Result", (-1).ToString());
                            }
                    } */
                    ...
                    {
                        ret = DataMapper.DefaultMapper.QueryForObject<Int32>("WRK700_INSERT_MAIN_LIST", param);
                    }
                ...
                {
                    DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("WRK700_CHECK_CNT_UPDATE", param);
                    ...
                    else
                    {
                        ...
                        ret = DataMapper.DefaultMapper.QueryForObject<Int32>("WRK700_UPDATE_MAIN_LIST", param);
                    }
        ...
        public DataPackage deleteMainList(DataPackage package)
        {
            ...
            try
            {
                Int32 ret = DataMapper.DefaultMapper.QueryForObject<Int32>("WRK700_DELETE_MAIN_LIST", package.KeyValues);
        ...
        public DataPackage getCodes(DataPackage package)
        {
            ...
            try
            {
                DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("WRK700_SELECT_CODE", package.KeyValues);
