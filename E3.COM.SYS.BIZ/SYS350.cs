...
namespace E3.COM.SYS.BIZ
{
    ...
    public class SYS350
    {
        public DataPackage DeleteItem(DataPackage package)
        {
            ...
            try
            {
                DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("SYS350_DELETE", package.JsonData.ToDictionary());
        ...
        public DataPackage SelectItems(DataPackage package)
        {
            ...
            try
            {
                DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("SYS350_SELECT", package.KeyValues);
        ...
        public DataPackage UpdateItem(DataPackage package)
        {
            ...
            try
            {
                ...
                DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("SYS350_COUNT", param);

                if (dataTable != null && dataTable.Rows[0]["CNT"].ToInt() > 0)
                {
                    dataHandleMode = "UPDATE";
                    ret = DataMapper.DefaultMapper.QueryForObject<Int32>("SYS350_UPDATE", param);
                }
                else
                {
                    ret = DataMapper.DefaultMapper.QueryForObject<Int32>("SYS350_INSERT", param);
                }
