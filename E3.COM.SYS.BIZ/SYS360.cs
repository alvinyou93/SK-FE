...
namespace E3.COM.SYS.BIZ
{
    ...
    public class SYS360
    {
        public DataPackage DeleteItem(DataPackage package)
        {
            ...
            try
            {
                DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("SYS360_DELETE", package.JsonData.ToDictionary());
        ...
        public DataPackage SelectItems(DataPackage package)
        {
            ...
            try
            {
                DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("SYS360_SELECT", package.KeyValues);
        ...
        public DataPackage UpdateItem(DataPackage package)
        {
            ...
            try
            {
                ...
                DataTable dataTable = DataMapper.DefaultMapper.QueryForDataTable("SYS360_COUNT", param);

                if (dataTable != null && dataTable.Rows[0]["CNT"].ToInt() > 0)
                {
                    dataHandleMode = "UPDATE";
                    ret = DataMapper.DefaultMapper.QueryForObject<Int32>("SYS360_UPDATE", param);
                }
                else
                {
                    ret = DataMapper.DefaultMapper.QueryForObject<Int32>("SYS360_INSERT", param);
                }
